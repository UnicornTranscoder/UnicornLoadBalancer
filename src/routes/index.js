...
export default (app) => {
  ...
  // MPEG Dash support
  app.get(
    "/:formatType/:/transcode/universal/start.mpd",
    RoutesTranscode.dashStart,
  );
  app.get(
    "/:formatType/:/transcode/universal/dash/:sessionId/:streamId/initial.mp4",
    RoutesTranscode.redirect,
  );
  app.get(
    "/:formatType/:/transcode/universal/dash/:sessionId/:streamId/:partId.m4s",
    RoutesTranscode.redirect,
  );
  app.all(
    "/:formatType/:/transcode/session/:sessionId/:streamId/progress",
    RoutesTranscode.progress,
  );

  // Long polling support
  app.get("/:formatType/:/transcode/universal/start", RoutesTranscode.lpStart);
  app.get(
    "/:formatType/:/transcode/universal/subtitles",
    RoutesTranscode.redirect,
  );

  // M3U8 support
  app.get(
    "/:formatType/:/transcode/universal/start.m3u8",
    RoutesTranscode.hlsStart,
  );
  app.get(
    "/:formatType/:/transcode/universal/session/:sessionId/base/index.m3u8",
    RoutesTranscode.redirect,
  );
  app.get(
    "/:formatType/:/transcode/universal/session/:sessionId/base-x-mc/index.m3u8",
    RoutesTranscode.redirect,
  );
  app.get(
    "/:formatType/:/transcode/universal/session/:sessionId/:fileType/:partId.ts",
    RoutesTranscode.redirect,
  );
  app.get(
    "/:formatType/:/transcode/universal/session/:sessionId/:fileType/:partId.vtt",
    RoutesTranscode.redirect,
  );
