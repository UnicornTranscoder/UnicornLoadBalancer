...
export default (app) => {
    ...
    // MPEG Dash support
    app.get('/:formatType/:/transcode/universal/start.mpd', (res, req) => {
    ...
    app.get('/:formatType/:/transcode/universal/start', (res, req) => {
        return RoutesTranscode.redirect(req, res);
    });
    app.get('/:formatType/:/transcode/universal/subtitles', RoutesTranscode.redirect);

    // M3U8 support
    app.get('/:formatType/:/transcode/universal/start.m3u8',  (res, req) => {
        return RoutesTranscode.redirect(req, res);
    });
